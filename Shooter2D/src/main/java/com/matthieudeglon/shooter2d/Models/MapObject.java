...
public abstract class MapObject extends Pane {
    ...
    protected final void positionTo(CoordinatesModel coordinates) { relocate(coordinates.getX(),coordinates.getY()); }

    public final double getCurrentXPosition() { return getLayoutX(); }

    public final double getCurrentYPosition() { return getLayoutY(); }

    public final CoordinatesModel getCurrentPosition() {return  new CoordinatesModel(getLayoutX(),getLayoutY());}
